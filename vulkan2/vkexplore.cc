...
const std::vector<Vertex> vertices = {
    {{-0.35f, -0.25f}, {1.0f, 0.0f, 0.0f}},
    {{ -0.1f,  0.25f}, {0.0f, 1.0f, 0.0f}},
    {{ -0.6f,  0.25f}, {0.0f, 0.0f, 1.0f}},
    {{ 0.35f, -0.25f}, {1.0f, 0.0f, 0.0f}},
    {{  0.6f,  0.25f}, {0.0f, 1.0f, 0.0f}},
    {{  0.1f,  0.25f}, {0.0f, 0.0f, 1.0f}},
};
...
private:
    ...
    void updateFrame() {
        ...
        const size_t verticiesBufferSize = sizeof(vertices[0]) * std::size(vertices);

        vkMapMemory(device, vertexBufferMemory, 0, verticiesBufferSize, 0, &gpuVertexBuffer);
        std::memcpy(gpuVertexBuffer, vertices.data(), verticiesBufferSize);
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        vkCmdBeginRenderPass(commandBuffer, &renderPassInfo, VK_SUBPASS_CONTENTS_INLINE);
            ...
            vkCmdDraw(commandBuffer, std::size(vertices), 1, 0, 0);
    ...
    void createVertexBuffer() {
        ...
        createInfo.size = sizeof(vertices[0]) * std::size(vertices);
